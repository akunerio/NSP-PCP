        ...
        <div class="setup-container">
          <div class="setup-content">
            <div class="page-header">
              <h1 class="google-style-heading">Homework 2: Share your Lebaran holiday.</h1>
            ...
            <div class="setup-instructions">
              <div class="instruction-content">
                <p class="instruction-intro"><b>Please describe what activities you did during the Lebaran holiday. You can write about what you did with your family and friends, whether you traveled, joined celebrations, or did anything special. You may also talk about your feelings or your favorite part of the holiday.</b></p>
...
function handleImageUpload(file, index) {
  ...
  reader.onload = (e) => {
    ...
    img.onload = () => {
      ...
      // Display preview interface and hide upload controls
...
async function analyzeImage(index) {
  try {
    ...
    // Toggle visibility between button and results
    ...
    // Render chips and description text
    result.data.keywords.forEach((keyword) => addKeywordChip(keyword, index));
...
async function validateAndProceed() {
  ...
  if (result.isConfirmed) {
    try {
      ...
      const response = await fetch("/initialize_homework2", {
        method: "POST",
        headers: {
      ...
      sessionStorage.setItem("hw2WritingSetup", JSON.stringify(setupData));
